                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <h4 class="mb-4">Receive messages instantly with our PHP and Ajax contact form - available in the <a href="https://htmlcodex.com/downloading/?item=2098">Pro Version</a> only.</h4>
                            <form>
                                <div class="row g-3">
                                    <div class="col-md-6">
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							<!--/*** The authorâs attribution link below must remain intact on your website. ***/-->
